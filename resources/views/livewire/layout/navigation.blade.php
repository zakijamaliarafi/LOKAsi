...
<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @role('admin')
                    <x-nav-link :href="route('user.manage')" :active="request()->routeIs('user.manage')" wire:navigate>
                        {{ __('Manage User') }}
                    </x-nav-link>
                    @endrole
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard') || request()->routeIs('home')" wire:navigate>
                {{ __('Dashboard') }}
            </x-responsive-nav-link>
            @role('admin')
            <x-responsive-nav-link :href="route('user.manage')" :active="request()->routeIs('user.manage')" wire:navigate>
                {{ __('Manage User') }}
            </x-responsive-nav-link>
            @endrole
        </div>
